...
class WeelkyQuiz_En_oct_1st extends StatefulWidget {
  final String? userIdentifier;

  WeelkyQuiz_En_oct_1st({Key? key, this.userIdentifier}) : super(key: key);

  @override
  State<WeelkyQuiz_En_oct_1st> createState() => _WeelkyQuiz_En_oct_1stState();
}

class _WeelkyQuiz_En_oct_1stState extends State<WeelkyQuiz_En_oct_1st> {
