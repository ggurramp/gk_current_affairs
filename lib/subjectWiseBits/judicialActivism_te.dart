...
class judicialActivism_te extends StatefulWidget {
  final String? userIdentifier;

  judicialActivism_te({Key? key, this.userIdentifier}) : super(key: key);

  @override
  State<judicialActivism_te> createState() => _judicialActivism_teState();
}

class _judicialActivism_teState extends State<judicialActivism_te> {
...
//28. న్యాయపరమైన కార్యాచరణ
    ...
    Question(
      ...
      options: ["రాజ్యాంగ సవరణల యొక్క న్యాయ సమీక్ష, చట్టం యొక్క న్యాయ సమీక్ష, పరిపాలనా చర్య యొక్క న్యాయ సమీక్ష", "శాసన సమీక్ష, పరిపాలనా సమీక్ష, రాజ్యాంగ సమీక్ష", "రాజ్యాంగ సవరణల సమీక్ష, శాసన సమీక్ష, పరిపాలనా చర్య సమీక్ష", " క్వాడ్రీ సమీక్ష , మార్షల్ సమీక్ష, మాడిసన్ సమీక్ష"],
    correctAnswerIndex : 0,
    ...
    Question(
      questionText : "1947లో 'జుడీషియల్ యాక్టివిజం' అనే పదాన్ని మొదట ఎవరు ఉపయోగించారు?",
      options: ["జస్టిస్ విఆర్ కృష్ణయ్యర్ " , "జస్టిస్ పిఎన్ భగవతి ", "జస్టిస్ ఓ. చిన్నప్ప రెడ్డి", "ఆర్థర్ ష్లెసింగర్ జూనియర్"],
      correctAnswerIndex : 3,
      explanation : "జ్యుడీషియల్ యాక్టివిజం' అనే పదాన్ని మొదటిసారిగా 1947లో అమెరికన్ చరిత్రకారుడు మరియు విద్యావేత్త అయిన ఆర్థర్ ష్లెసింగర్ జూనియర్ రూపొందించారు.",
    ),

    Question(
      questionText : "న్యాయమూర్తులు చట్టాన్ని రూపొందించే విషయంలో న్యాయపరమైన క్రియాశీలతను ఎలా నిర్వచించారు?",
      options: [
        "ఇది న్యాయపరమైన అధికారాన్ని వినియోగించే మార్గం, ఇది న్యాయపరమైన పూర్వాపరాలకు ఖచ్చితంగా కట్టుబడి ఉంటుంది. ",
        "స్థాపిత పూర్వాపరాలకు దూరంగా ఉండే నిర్ణయాల ద్వారా వ్యక్తిగత హక్కులను రక్షించడం లేదా విస్తరించడం అనేది న్యాయవ్యవస్థలో ఒక అభ్యాసం. ",
        "ఇది సామాజిక అభివృద్ధి కోసం ప్రస్తుత చట్టం యొక్క ప్రయోజనాన్ని మెరుగుపరచడానికి న్యాయమూర్తులచే చట్టాన్ని రూపొందించే ప్రక్రియ. ",
        "ఇది న్యాయపరమైన నిర్ణయం తీసుకునే తత్వశాస్త్రం, దీని ద్వారా న్యాయమూర్తులు వారి నిర్ణయాలకు మార్గనిర్దేశం చేసేందుకు పబ్లిక్ పాలసీ గురించి వారి వ్యక్తిగత అభిప్రాయాలను అనుమతిస్తారు."
      ],
      correctAnswerIndex : 2,
      explanation : "న్యాయ క్రియాశీలత అనేది న్యాయమూర్తులచే చట్టాన్ని రూపొందించే ప్రక్రియగా నిర్వచించబడింది, సామాజిక అభివృద్ధి కోసం దాని ప్రయోజనాన్ని మెరుగుపరచడానికి ఇప్పటికే ఉన్న చట్టం యొక్క క్రియాశీల explanationను కలిగి ఉంటుంది.",
    ),

    Question(
      questionText : "న్యాయపరమైన క్రియాశీలతకు వ్యతిరేకత ఏమిటి?",
      options: ["న్యాయ నిగ్రహం", "న్యాయ సమీక్ష", "న్యాయ జోక్యం", "న్యాయ explanation"],
      correctAnswerIndex : 0,
      explanation : "న్యాయపరమైన క్రియాశీలత యొక్క వ్యతిరేకత 'న్యాయ నిగ్రహం', అంటే న్యాయవ్యవస్థ ద్వారా స్వీయ నియంత్రణ పాటించడం.",
    ),
