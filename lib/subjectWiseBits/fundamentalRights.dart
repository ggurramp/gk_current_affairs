...
class fundamentalRights extends StatefulWidget {
  final String? userIdentifier;

  fundamentalRights({Key? key, this.userIdentifier}) : super(key: key);

  @override
  State<fundamentalRights> createState() => _fundamentalRightsState();
}

class _fundamentalRightsState extends State<fundamentalRights> {
