...
class FavoriteQuestionsScreen_hi extends StatelessWidget {
  final List<String> FavoriteQuestions_hi;
  final List<String> explanations;

  FavoriteQuestionsScreen_hi({required this.FavoriteQuestions_hi, required this.explanations});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
        itemCount: FavoriteQuestions_hi.length,
        itemBuilder: (context, index) {
          return ExpansionTile(
            title: Text('Question: ${FavoriteQuestions_hi[index]}'),
            children: [
              Padding(
