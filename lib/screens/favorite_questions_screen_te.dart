...
class FavoriteQuestionsScreen_te extends StatelessWidget {
  final List<String> FavoriteQuestions_te;
  final List<String> explanations;

  FavoriteQuestionsScreen_te({required this.FavoriteQuestions_te, required this.explanations});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
        itemCount: FavoriteQuestions_te.length,
        itemBuilder: (context, index) {
          return ExpansionTile(
            title: Text('Question: ${FavoriteQuestions_te[index]}'),
            children: [
              Padding(
