...
class judicialReview extends StatefulWidget {
  final String? userIdentifier;

  judicialReview({Key? key, this.userIdentifier}) : super(key: key);

  @override
  State<judicialReview> createState() => _judicialReviewState();
}

class _judicialReviewState extends State<judicialReview> {
